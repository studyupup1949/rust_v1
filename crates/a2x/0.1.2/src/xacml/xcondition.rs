...
fn type_for_expr(
    ...
    match e {
        ...
        CondExpression::Attr(ad) => {
            ...
            // a2x#12 - we need a src_loc available here.
        ...
        CondExpression::Fn(fn_call) => {
            ...
            match &func.output_arg {
                ...
                FunctionOutputArg::AnyAtomic => Ok(FunctionTypeResolved::AnyAtomic),
                FunctionOutputArg::AnyAtomicBag => Ok(FunctionTypeResolved::AnyAtomicBag),
            }
        }
